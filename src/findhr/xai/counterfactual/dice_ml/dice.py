...
from findhr.xai.counterfactual.dice_ml.constants import BackEndTypes, SamplingStrategy
from findhr.xai.counterfactual.dice_ml.data_interfaces.private_data_interface import PrivateData
...
def decide(model_interface, method):
    ...
    if method == SamplingStrategy.Random:
        ...
        from findhr.xai.counterfactual.dice_ml.explainer_interfaces.dice_random import DiceRandom
        return DiceRandom
    elif method == SamplingStrategy.Genetic:
        from findhr.xai.counterfactual.dice_ml.explainer_interfaces.dice_genetic import DiceGenetic
        return DiceGenetic
    elif method == SamplingStrategy.KdTree:
        from findhr.xai.counterfactual.dice_ml.explainer_interfaces.dice_KD import DiceKD
        return DiceKD
    elif method is None:
        # all other backends
