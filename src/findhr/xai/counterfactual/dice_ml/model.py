...
from findhr.xai.counterfactual.dice_ml.constants import BackEndTypes, ModelTypes
...
def decide(backend):
    ...
    if backend == BackEndTypes.Sklearn:
        ...
        from findhr.xai.counterfactual.dice_ml.model_interfaces.base_model import BaseModel
        return BaseModel
        ...
        module = __import__("findhr.xai.counterfactual.dice_ml.model_interfaces." + module_name, fromlist=[class_name])
